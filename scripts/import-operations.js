...
/**
 * Operations Bulk Importer for IMC Pelita Logistik KMS
 */
...
const SOURCE_DIR = path.join(__dirname, '..', 'KMS-Demo', '02-Operations');
const COLLECTION_NAME = 'Operations';
const COLLECTION_DESCRIPTION = 'Operational procedures for IMC Pelita Logistik fleet and transshipment operations';
const COLLECTION_COLOR = '#1E88E5'; // Blue for operations
...
async function main() {
    ...
    console.log('Operations Bulk Importer for IMC Pelita Logistik KMS');
    console.log('='.repeat(60));
    console.log();
