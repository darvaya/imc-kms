...
/**
 * Governance Bulk Importer for IMC Pelita Logistik KMS
 */
...
const SOURCE_DIR = path.join(__dirname, '..', 'KMS-Demo', '05-Governance');
const COLLECTION_NAME = 'Governance';
const COLLECTION_DESCRIPTION = 'Corporate governance, compliance, and risk management';
const COLLECTION_COLOR = '#F57C00'; // Orange
...
async function main() {
    ...
    console.log('Governance Importer for IMC Pelita Logistik KMS');
    console.log('='.repeat(60));
    console.log();
