...
/**
 * HR Bulk Importer for IMC Pelita Logistik KMS
 */
...
const SOURCE_DIR = path.join(__dirname, '..', 'KMS-Demo', '04-HR');
const COLLECTION_NAME = 'Human Resources';
const COLLECTION_DESCRIPTION = 'HR policies, seafarer management, and employee information';
const COLLECTION_COLOR = '#43A047'; // Green
...
async function main() {
    ...
    console.log('HR Bulk Importer for IMC Pelita Logistik KMS');
    console.log('='.repeat(60));
    console.log();
