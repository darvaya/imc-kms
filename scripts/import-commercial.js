...
/**
 * Commercial Bulk Importer for IMC Pelita Logistik KMS
 */
...
const SOURCE_DIR = path.join(__dirname, '..', 'KMS-Demo', '06-Commercial');
const COLLECTION_NAME = 'Commercial';
const COLLECTION_DESCRIPTION = 'Chartering, contracts, and customer management';
const COLLECTION_COLOR = '#00ACC1'; // Cyan
...
async function main() {
    ...
    console.log('Commercial Importer for IMC Pelita Logistik KMS');
    console.log('='.repeat(60));
    console.log();
